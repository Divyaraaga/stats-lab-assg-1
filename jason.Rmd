...
#summary(description)
#par(las=1, mar=c(2.5,8,2, 0.7)) #Sets plot margins : b, l, t, r 
...
barplot(amount_sumK_party[order(amount_sumK_party)], horiz = TRUE , las = 1, main ="Total Debt by Party" , xlab="Total debt amount" ,cex.axis = .9 ,cex.names= 0.9 , col = colorTAPalette)
```
...
barplot(amount_means_party[order(amount_means_party)], horiz = TRUE , las = 1, main ="Mean Debt by Party" , xlab="Mean debt amount" ,cex.axis = .9 ,cex.names= 0.9 , col = colorMAPalette, xlim = c(0, 2000)) 
```
...
main = "Debt amount wrt to party", col = colorBAPalette, xlab = "Debt amount")
...
par(las=1, mar=c(5,10,2,0.8)) #Sets outside margins : b, l, t, r 
barplot(amount_sumK_office[order(amount_sumK_office)], horiz = TRUE , las = 1, main ="Total Debt by Office" , xlab="Total debt" ,cex.axis = .8 ,cex.names= 0.6 , col = terrain.colors(16) , )
```

Comparing with mean values as before, we find that appeals court judges have relatively high debt. 
...
barplot(amount_means_office[order(amount_means_office)], horiz = TRUE , las = 1, main ="Mean Debt by Office" , xlab="Mean debt" ,cex.axis = .9 ,cex.names= 0.5 , col = terrain.colors(16), xlim = c(0, 4000)) 
