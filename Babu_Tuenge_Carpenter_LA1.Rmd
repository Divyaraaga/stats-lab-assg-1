...
#$debtdate = as.Date(cdebt_revised$debtdate, "%m/%d/%Y") + 365.25 * 2000 - 15
#summary(cdebt_revised$thrudate)
...
#Divya to Jason  : As you were modifyong the same variable cdebt_revised$* , running the chucks multiple times was 
#messing up the calculations , Try running this data multiple times
