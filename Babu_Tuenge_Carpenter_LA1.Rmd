...
Divya to jason : I copied it as is from candidateDebt.rmd file .. you can knit the file and check it
...
Divya to jason : you had this line before
...
str(unique(cdebt_revised$reportnumber))

#str(as.factor(cdebt_revised$reportnumber))
``` 
```{r}
